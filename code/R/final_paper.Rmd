...
We hypothesize that those who participate in collaborative playlists:
    a. Value listening and sharing music with others. [7.4] -SY
    b. Frequently engage in listening and sharing music with others. [7.4] -SY
    c. Frequently engage in discovering new music. [7.6] -SY
    d. Experiment more with new and unfamiliar music. [7.10] -Alexa
    
2. Do patterns of user behavior change depending on a collaborator's level of engagement? We hypothesize that highly engaged collaborators: [5.16, 5.20, 5.21, 7.6, 7.10]
    a. Make more frequent contributions to a shared playlist. -Alexa
    b. Have higher level of playlist ownership. -Alexa
    c. More frequently add new songs to a playlist. -SY
    
Exploratory:
- music platform for different activities -Alexa
- favorite CP and time -SY
